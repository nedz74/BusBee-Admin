        ...
        <View style={styles.topContent}>
          ...
          <View style={styles.phoneInputContainer}>
            <TextInput
              ...
              maxLength={10}
            />
            <View style={[styles.inputUnderline, phoneError && styles.inputUnderlineError]} />
            {phoneError && (
...
const styles = StyleSheet.create({
  ...
  content: { flex: 1, paddingHorizontal: 20, paddingTop: 40, justifyContent: 'space-between' },
  topContent: { flex: 1, marginTop: 30 },
  ...
  continueButton: { backgroundColor: '#D81030', paddingVertical: 10, borderRadius: 8, alignItems: 'center', marginBottom: 60 },
